...
public class CartController {
    ...
    public String buy(@PathVariable("id") int id, HttpSession session, ModelMap model) {
        ...
        if (session.getAttribute("cart") == null) {
            ...
            for (Item i : cart){
                System.out.println(i.getDateFrom());
            }
    ...
    public String checkout(HttpSession session, ModelMap model, Principal principal) {
        ...
        if (session.getAttribute("cart") == null) {
            ...
            orders.setTimeCreation(new Time(new Date().getTime()));
            orders.setDateFrom(new Date().toString());
            orders.setDateTo(new Date().toString());
