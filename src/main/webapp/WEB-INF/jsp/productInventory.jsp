    ...
    <div class="container">
        <div class="page-header">
            ...
            <table id="example" class="display" cellspacing="0" width="100%" >
                <thead>
                    <tr class="bg-primary" style="background-color: orangered">
                        <th></th>
                        <th>Ime</th>
                        <th>Kategorija</th>
                        <th>Cena(po danu)</th>
                ...
                <c:forEach items="${products}" var="product">
                    <tr>
                        ...
                        <td>${product.productFuel} litara </td>
                        <td>
            ...
            <a href="<spring:url value="/admin/product/addProduct" />" class="btn btn-primary" style="background-color: orangered">Dodaj automobil</a>
