...
<div class="container-wrapper" style="color: white">
    <div class="container">
        <div class="page-header">
            ...
            <p class="lead" style="color: white">Popuni polja da bi dodao automobil:</p>
        </div>
        ...
        <form:form action="${pageContext.request.contextPath}/admin/product/addProduct"
            ...
            <div class="form-group">
                <label for="productFuel"> Gorivo: </label>
                <form:errors path="productFuel" cssStyle="color:#ff0000;" />
                <form:input path="productFuel" id="productFuel" class="form-Control"  />
            </div>
