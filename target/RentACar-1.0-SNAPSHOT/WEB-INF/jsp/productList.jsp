            ...
            <ul class="rig columns-3">
                <c:forEach items="${products}" var="product">
                    ...
                    <li>
                        ...
                        <h4>Cena(po danu): ${product.productPrice} RSD</h4>
                        <h4>Vise informacija mozete dobiti klikom <a href="<spring:url value="/product/viewProduct/${product.productId}" />" style="color: orangered"> ovde </a></h4>
                    </li>
                </c:forEach>
            </ul>
        </div>
